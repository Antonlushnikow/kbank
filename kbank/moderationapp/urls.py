...
urlpatterns = [
    ...
    path('article/<int:pk>/moderate-required/', ArticleModerationRequired.as_view(), name='set-moderation-required'),
    path('article/<int:pk>/moderation-passed/', ArticleModerationPassed.as_view(), name='set-moderation-passed'),
